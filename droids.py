...
time.sleep(2)
print("Welcome to <<The Droid's Adventure>> game. First, please log in.")
print("")
time.sleep(2)
print("-------------------------")
print("PDIT Security Software ©")
print("-------------------------")
print("")
time.sleep(2)
print("Loading...")
...
if password  == "kink@ju15" :
    print ("ACCESS  GRANTED")
    print ("<<Welcome Gamer!>>")
    print ("Now, you can play the game! Have Fun, and hope you enjoy")
    time.sleep(6)
else :
...
Wait a little bit untill you get clear vision''')
time.sleep(10)
def start(inventory):
	print('\n----------')
	print('\nDroid mobile..')
...
def getcmd(cmdlist):
	...
	if cmd in cmdlist:
		...
		time.sleep(1)
		print('\n[--written by Paul Dan for Commodore 64 PC--]')
		time.sleep(1)
